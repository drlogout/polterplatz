defmodule PolterplatzWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PolterplatzWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PolterplatzWeb.Gettext, "errors", msg, opts)
    end
  end
